-- First, let's add a unique constraint on title to help identify quests
ALTER TABLE quest_templates ADD CONSTRAINT quest_templates_title_key UNIQUE (title);

-- Insert assessment quest templates with proper UUIDs
...
SET order_index = 100 
WHERE is_assessment = FALSE AND order_index IS NULL;